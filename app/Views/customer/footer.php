...
<script src="<?php echo base_url('user/js/vendor/jquery-3.2.1.min.js'); ?>"></script>
...
<script src="<?php echo base_url('user/js/slick.min.js'); ?>"></script>
<script src="<?php echo base_url('user/js/owl.carousel.min.js'); ?>"></script>
<!-- Waypoints.min.js. -->
<script src="<?php echo base_url('user/js/waypoints.min.js'); ?>"></script>
